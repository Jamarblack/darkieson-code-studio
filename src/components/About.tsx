...
const About = () => {
  ...
  return (
    <section id="about" ref={ref} className="py-24 bg-gray-50 dark:bg-gray-950 dark:text-gray-50">
      <div className="responsive-container">
        ...
        <div className={cn(
          ...
          <div className="bg-white dark:bg-gray-950 dark:border-2 p-6 rounded-xl shadow-xl-gray-50 hover-up">
            <div className="text-3xl font-bold text-brand-blue">5+</div>
            <div className="text-gray-600">Years Experience</div>
          </div>
          <div className="bg-white dark:bg-gray-950 dark:border-2  p-6 rounded-xl shadow-sm hover-up">
